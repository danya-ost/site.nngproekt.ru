...
$this->title = 'Добавление поста в блог';
?>
    <div class="container">
...
$script = <<<JS
    ...
    elements.btnSave.on('click', function (){
        $.ajax({
            url: '/frontend/web/blog/add-post',
            type: 'post',
            dataType: 'html',
            data: {
            ...
            success: function (response){
                ...
                getLogs('blog', 'add', 'adding blog post id: '+response, 1, false);
            },
            error: function (response){
                getLogs('blog', 'add', 'adding blog post: '+values.title.val(), 0, response['responseText']);
                alert("Упс! Кажется произошла ошибка при загрузке данных. Пожалуйста, перезагрузите страницу или попробуйте позже!\\n\\nОтвет ошибки:\\n" + response['responseText']);
                console.log(response);
            }
        }) 
