...
?>
<div class="w-full h-[510px] bg-no-repeat bg-center bg-cover relative" id="content_a_b_i" style="background-image: url('/frontend/web/<?= $data['about_banner_image']['text'] ?>');">
    <div class="hidden" id="a_b_i" data-template="about_<?= $data['about_banner_image']['id'] ?>"><?= $data['about_banner_image']['text'] ?></div>
    <?php if ( $permission['adminTemplateAbout'] ): ?>
    ...
    <div class="w-full h-full bg-[#0000008F] px-11 flex items-center justify-start">
        <div>
            <div data-template="about_<?= $data['about_title']['id'] ?>" class="font-bold text-xl md:text-3xl lg:text-5xl text-white mb-4">
                <?= $data['about_title']['text'] ?>
            </div>
            <div data-template="about_<?= $data['about_title_2']['id'] ?>" class="font-bold text-base md:text-xl lg:text-3xl text-white">
...
<div class="container h-auto px-5 lg:px-0">
    <div class="w-full h-auto relative">
        <div data-template="about_<?= $data['about_description']['id'] ?>" class="max-w-[1040px] bg-main-gray p-6 font-light text-xl text-white relative -top-20 left-2/4 -translate-x-2/4 whitespace-pre-wrap"><?= $data['about_description']['text'] ?></div>
    </div>
    <div class="w-full h-auto grid grid-cols-1 md:grid-cols-[40%_60%] grid-rows-2 md:grid-rows-1">
        <div class="bg-no-repeat bg-center bg-cover relative" id="content_a_c_i" style="background-image: url('/frontend/web/<?= $data['about_company_image']['text'] ?>');">
            <div class="hidden" id="a_c_i" data-template="about_<?= $data['about_company_image']['id'] ?>"><?= $data['about_company_image']['text'] ?></div>
            <button name="add_image_a_c_i" style="display: none;" class="absolute right-5 bottom-5 inline-block align-middle text-center rounded px-6 py-2.5 ml-1 mt-1 md:mt-0 bg-black opacity-50 hover:opacity-100 text-white font-medium text-xs leading-tight uppercase hover:bg-gray-900 hover:shadow-lg focus:bg-gray-900 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 inline-block align-middle">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                </svg>
                <span class="ml-1 inline-block align-middle">Заменить</span>
        ...
        <div class="px-0 md:px-8 py-5">
            <div data-template="about_<?= $data['about_company_title']['id'] ?>" class="inline-block font-bold text-4xl text-white bg-main-red px-10 py-2 mb-10 relative left-0 md:-left-1/4">
                <?= $data['about_company_title']['text'] ?>
            </div>
            <div data-template="about_<?= $data['about_company_description']['id'] ?>" class="font-medium text-sm text-black whitespace-pre-wrap"><?= $data['about_company_description']['text'] ?></div>
        </div>
    </div>
    <div class="w-full h-auto py-11">
        <div class="max-w-[1040px] m-auto bg-main-red block md:grid grid-cols-[20%_80%] grid-rows-1">
            ...
            <div class="py-6 pr-5 pl-5 md:pl-0">
                <div data-template="about_<?= $data['about_mission_title']['id'] ?>" class="font-bold text-4xl text-white mb-6">
                    <?= $data['about_mission_title']['text'] ?>
                </div>
                <div data-template="about_<?= $data['about_mission_description']['id'] ?>" class="font-light text-xl text-white">
    ...
    <div class="w-full h-auto grid grid-cols-1 md:grid-cols-[40%_60%] grid-rows-2 md:grid-rows-1">
        <div class="bg-no-repeat bg-center bg-cover relative" id="content_a_w_i" style="background-image: url('/frontend/web/<?= $data['about_worker_image']['text'] ?>');">
            <div class="hidden" id="a_w_i" data-template="about_<?= $data['about_worker_image']['id'] ?>"><?= $data['about_worker_image']['text'] ?></div>
            <button name="add_image_a_w_i" style="display: none;" class="absolute right-5 bottom-5 inline-block align-middle text-center rounded px-6 py-2.5 ml-1 mt-1 md:mt-0 bg-black opacity-50 hover:opacity-100 text-white font-medium text-xs leading-tight uppercase hover:bg-gray-900 hover:shadow-lg focus:bg-gray-900 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 inline-block align-middle">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                </svg>
                <span class="ml-1 inline-block align-middle">Заменить</span>
        ...
        <div class="px-0 md:px-8 py-5">
            <div data-template="about_<?= $data['about_worker_title']['id'] ?>" class="inline-block font-bold text-4xl text-white bg-main-red px-10 py-2 mb-10 relative left-0 md:-left-1/4">
                <?= $data['about_worker_title']['text'] ?>
            </div>
            <div data-template="about_<?= $data['about_worker_description']['id'] ?>" class="font-medium text-sm text-black whitespace-pre-wrap"><?= $data['about_worker_description']['text'] ?></div>
        </div>
    </div>
    <div class="w-full h-auto py-10">
        <div class="w-full h-full bg-[#F1F1F1] px-16 py-9">
            <div data-template="about_<?= $data['about_number_title']['id'] ?>" class="font-bold text-4xl text-black mb-11">
                <?= $data['about_number_title']['text'] ?>
            </div>

            <div class="w-full h-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-14">
                <div>
                    <div data-template="about_<?= $data['about_number_01']['id'] ?>" class="font-extrabold text-4xl lg:text-[56px] text-main-red">
                        <?= $data['about_number_01']['text'] ?>
                    </div>
                    <div data-template="about_<?= $data['about_number_01_text']['id'] ?>" class="font-semibold text-lg lg:text-2xl text-black">
                        <?= $data['about_number_01_text']['text'] ?>
                    </div>
                </div>
                <div>
                    <div data-template="about_<?= $data['about_number_02']['id'] ?>" class="font-extrabold text-4xl lg:text-[56px] text-main-red">
                        <?= $data['about_number_02']['text'] ?>
                    </div>
                    <div data-template="about_<?= $data['about_number_02_text']['id'] ?>" class="font-semibold text-lg lg:text-2xl text-black">
                        <?= $data['about_number_02_text']['text'] ?>
                    </div>
                </div>
                <div>
                    <div data-template="about_<?= $data['about_number_03']['id'] ?>" class="font-extrabold text-4xl lg:text-[56px] text-main-red">
                        <?= $data['about_number_03']['text'] ?>
                    </div>
                    <div data-template="about_<?= $data['about_number_03_text']['id'] ?>" class="font-semibold text-lg lg:text-2xl text-black">
                        <?= $data['about_number_03_text']['text'] ?>
                    </div>
                </div>
                <div>
                    <div data-template="about_<?= $data['about_number_04']['id'] ?>" class="font-extrabold text-4xl lg:text-[56px] text-main-red">
                        <?= $data['about_number_04']['text'] ?>
                    </div>
                    <div data-template="about_<?= $data['about_number_04_text']['id'] ?>" class="font-semibold text-lg lg:text-2xl text-black">
                        <?= $data['about_number_04_text']['text'] ?>
                    </div>
                </div>

                <div>
                    <div data-template="about_<?= $data['about_number_05']['id'] ?>" class="font-extrabold text-4xl lg:text-[56px] text-main-red">
                        <?= $data['about_number_05']['text'] ?>
                    </div>
                    <div data-template="about_<?= $data['about_number_05_text']['id'] ?>" class="font-semibold text-lg lg:text-2xl text-black">
                        <?= $data['about_number_05_text']['text'] ?>
                    </div>
                </div>

                <div>
                    <div data-template="about_<?= $data['about_number_06_title']['id'] ?>" class="font-semibold text-lg lg:text-2xl text-main-red leading-3">
                        <?= $data['about_number_06_title']['text'] ?>
                    </div>
                    <div data-template="about_<?= $data['about_number_06']['id'] ?>" class="font-extrabold text-4xl lg:text-[56px] text-main-red">
                        <?= $data['about_number_06']['text'] ?>
                    </div>
                    <div data-template="about_<?= $data['about_number_06_text']['id'] ?>" class="font-semibold text-lg lg:text-2xl text-black">
...
$script = <<<JS
    ...
    $('#openEdit').on('click', function (){
        $(this).hide();
        $('div[data-template^=\'about_\']').each(function (){
        ...
        $('button[name=\'add_image_a_b_i\']').show();
        $('button[name=\'add_image_a_c_i\']').show();
        $('button[name=\'add_image_a_w_i\']').show();
        $('#saveEdit').show();
    });
    ...
    $('#saveEdit').on('click', function (){
        ...
        let data = [];
        $('div[data-template^=\'about_\']').each(function (){
            let id = $(this).attr('data-template').replace('about_', '');
            let content = $(this).text();
            data.push([id, content.trim()]);
        });
        $.ajax({
            url: '/frontend/web/home/about-update',
            type: 'post',
            dataType: 'html',
            data: { 'data': data },
            beforeSend: function (){
            ...
            success: function (response){
                getLogs('template', 'about', 'updating data to about page', 1, false);
                location.reload();
            }, 
            error: function (response){
                getLogs('template', 'about', 'updating data to about page', 0, response['responseText']);
                alert("Упс! Кажется произошла ошибка при загрузке данных. Пожалуйста, перезагрузите страницу или попробуйте позже!\\n\\nОтвет ошибки:\\n" + response['responseText']);
                console.log(response);
            } 
        });
