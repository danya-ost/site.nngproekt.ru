...
?>
<a href="<?= Url::to(['/initiative/view-initiative', 'i' => $item['id']]) ?>" id="initiative_01" type="button" class="block h-[250px] sm:h-[220px] text-left align-top bg-white shadow-[0px_0px_10px_0px_#00000017] px-6 py-5 relative">
