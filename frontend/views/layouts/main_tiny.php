...
<head>
    ...
    <script src="/frontend/web/js/tinymce.min.js" referrerpolicy="origin"></script>
    <style>
...
<main role="main" class="w-full h-auto px-5 pl-5 lg:pl-[140px] pt-[106px] lg:pt-[190px] min-h-screen">
    <?= $content ?>
</main>
