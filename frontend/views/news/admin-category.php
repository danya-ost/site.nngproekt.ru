...
<div id="main-div" class="container h-auto">
    ...
    <div class="w-full ha-auto mb-6">
        <h1 class="font-bold text-4xl uppercase">КАТЕГОРИИ НОВОСТЕЙ</h1>
    </div>
    ...
    <?php if ( $permission['addNewsCategory'] ) : ?>
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable relative w-auto pointer-events-none">
        <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding outline-none text-current">
            ...
            <div id="modelFooter" class="modal-footer flex flex-shrink-0 flex-wrap items-center justify-center p-4 border-t border-gray-200">
                ...
                <?php if ( $permission['deleteNewsCategory'] ): ?>
...
$script = <<<JS
    ...
    function getCategory(){
        $.ajax({
            url: '/frontend/web/news/view-category',
            type: 'post',
            dataType: 'html',
            data: 1,
            beforeSend: function (){
    ...
    elements.container.on('click', 'div[name^=\'category_view_\']', function (){
        ...
        $.ajax({
            url: '/frontend/web/news/view-current-category',
            type: 'post',
            dataType: 'html',
            data: { 'id': current_id },
            beforeSend: function (){
    ...
    elements.update_category.on('click', function (){
        ...
        $.ajax({
            url: '/frontend/web/news/update-category',
            type: 'post',
            dataType: 'html',
    ...
    elements.delete_category.on('click', function (){
        $.ajax({
            url: '/frontend/web/news/delete-category',
            type: 'post',
            dataType: 'html',
            data: { 'id': current_id },
            beforeSend: function (){
    ...
    elements.add_category.on('click', function (){
       ...
       $.ajax({
            url: '/frontend/web/news/add-category',
            type: 'post',
            dataType: 'html',
            data: { 'value': value },
            beforeSend: function (){
