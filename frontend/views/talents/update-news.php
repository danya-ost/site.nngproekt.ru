...
?>
    <div class="container">
        ...
        <form id="newsContainer" data-news="<?= $_GET['n'] ?>" class="w-full h-auto">
            ...
            <div id="covers" class="mt-5 grid grid-cols-1 sm:grid-cols-2 grid-rows-1 gap-5">
                <div>
                    ...
                    <input type="hidden" name="image" id="image" value="<?= $data['image_src'] ?>">
                    <div id="imageView" class="min-h-[350px] max-h-full w-full bg-cover bg-center bg-no-repeat" style="background-image: url('/frontend/web/<?= $data['image_src'] ?>')"></div>
                </div>
                <div>
                    <label for="video" class="font-light text-xs text-stone-500">
                        Видео
                    </label>
                    <input type="hidden" name="video" id="video" value="<?= $data['video_src'] ?>">
                    <video id="videoView" src="/frontend/web/<?= $data['video_src'] ?>" height="350" controls class="w-full" style="height: 350px;">
                        <source id="videoViewSrc" src="/frontend/web/<?= $data['video_src'] ?>" type="video/mp4">
                    </video>
                </div>
            </div>
            ...
            <div class="py-10">
                ...
                <button type="button" id="onFixed" <?php if ( $data['fixed'] == 1 ): ?> style="display: none;" <?php endif; ?> class="inline-block align-middle rounded mt-1 px-6 py-2.5 ml-1 bg-gray-800 text-white font-medium text-xs leading-tight uppercase shadow-md hover:bg-gray-900 hover:shadow-lg focus:bg-gray-900 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 inline-block align-middle">
                ...
                <button type="button" id="offFixed" <?php if ( $data['fixed'] == 0 ): ?> style="display: none;" <?php endif; ?> class="inline-block align-middle rounded mt-1 px-6 py-2.5 ml-1 bg-gray-200 text-gray-700 font-medium text-xs leading-tight uppercase shadow-md hover:bg-gray-300 hover:shadow-lg focus:bg-gray-300 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-400 active:shadow-lg transition duration-150 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 inline-block align-middle">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0112 21 8.25 8.25 0 016.038 7.048 8.287 8.287 0 009 9.6a8.983 8.983 0 013.361-6.867 8.21 8.21 0 003 2.48z" />
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 18a3.75 3.75 0 00.495-7.467 5.99 5.99 0 00-1.925 3.546 5.974 5.974 0 01-2.133-1A3.75 3.75 0 0012 18z" />
                    </svg>
                ...
                <button type="button" id="sendForm" class="inline-block align-middle rounded md:float-right mt-1 px-6 py-2.5 ml-1 bg-gray-800 text-white font-medium text-xs leading-tight uppercase shadow-md hover:bg-gray-900 hover:shadow-lg focus:bg-gray-900 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 inline-block align-middle">
...
$script = <<<JS
    ...
    elements.btnSave.on('click', function (){
        $.ajax({
            url: '/frontend/web/talents/update-news',
            type: 'post',
            dataType: 'html',
            data: {
                'id': elements.container.attr('data-news'),
