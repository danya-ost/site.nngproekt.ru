...
/** @var \frontend\controllers\TalentsController $user_id */
...
foreach ( $data  as $item ):
    ...
    <div class="mb-6 last:mb-0">
        ...
        <div>
            ...
            <?php if ( $permission['updateTalents'] || $item['user_id'] == $user_id ): ?>
        ...
        <?php $responsesComment = \frontend\models\TalentsComments::find()->where(['status' => 1])->andWhere(['parent_comment_id' => $item['id']])->orderBy(['date_add' => SORT_DESC])->all(); ?>
                ...
                <div class="mt-4 grid grid-cols-[60px_auto]">
                    ...
                    <div>
                        <div class="mb-4 last:mb-0">
                            ...
                            <div>
                                <?php if ( $permission['updateTalents'] || $rescomment['user_id'] == $user_id ): ?>
