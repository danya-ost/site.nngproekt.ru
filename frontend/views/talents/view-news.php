...
/** @var \frontend\controllers\TalentsController $breadcrumbs */
/** @var \frontend\controllers\TalentsController $liked */
/** @var \frontend\controllers\TalentsController $permission */
/** @var \frontend\controllers\TalentsController $user_avatar */
...
<div class="container h-auto">
    ...
    <?php if ( $permission['addTalents'] || $permission['updateTalents'] || $permission['deleteTalents'] ): ?>
        <div class="relative rounded overflow-hidden my-5 bg-white shadow-sm hover:shadow-lg px-2 py-3 border border-solid border-stone-200 duration-200 ease-in-out transition-all pb-10 sm:pb-3">
            ...
            <?php if ( $permission['updateTalents'] ): ?>
                <a href="<?= Url::to(['/talents/update-news-form', 'n' => $data['id']]) ?>" class="block sm:inline-block align-middle text-center rounded px-6 py-2.5 ml-1 mt-1 md:mt-0 bg-stone-300 text-white font-medium text-xs leading-tight uppercase hover:bg-gray-900 hover:shadow-lg focus:bg-gray-900 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out">
            ...
            <?php endif; ?>
            <?php if ( $permission['deleteTalents'] ): ?>
...
$script = <<<JS
    ...
    $.ajax({
        url: '/frontend/web/talents/views',
        type: 'post',
        dataType: 'html',
        data: { 'id': e.id_news },
    ...
    $.ajax({
        url: '/frontend/web/talents/relevant-news',
        type: 'post',
        dataType: 'html',
        data: { 'id': e.id_news },
    ...
    e.btn_liked.on('click', function (){
        ...
        $.ajax({
            url: '/frontend/web/talents/liked',
            type: 'post',
            dataType: 'html',
    ...
    $('#btnDelete').on('click', function (){
        $.ajax({
            url: '/frontend/web/talents/delete-news',
            type: 'post',
            data: { 'id': delete_id },
            dataType: 'html',
            beforeSend: function (){
            ...
            success: function (response){
                window.location.href = '/frontend/web/talents/index';
            },
            error: function (response){
                alert("Упс! Кажется произошла ошибка при загрузке данных. Пожалуйста, перезагрузите страницу или попробуйте позже!\\n\\nОтвет ошибки:\\n" + response['responseText']);
                console.log(response);
    ...
    $.ajax({
        url: '/frontend/web/talents/view-comments',
        type: 'post',
        dataType: 'html',
        data: { 'id': e.id_news },
        success: function (response){
    ...
    $('#sendComment').on('click', function (){
        ...
        if ( get_comment_type == 0 ){
            $.ajax({
                url: '/frontend/web/talents/add-comment',
                type: 'post',
    ...
    $('#comments').on('click', '#responseComment', function (){
        ...
        $.ajax({
            url: '/frontend/web/talents/view-user-news',
            type: 'post',
            dataType: 'html',
            data: { 'id': id_response },
            success: function (response){
    ...
    $('#comments').on('click', '#deleteComment', function (){
        $.ajax({
            url: '/frontend/web/talents/delete-comment',
            type: 'post',
            dataType: 'html',
